...
ENTITIES: tuple[EntitySpec, ...] = (
    ...
    EntitySpec(
        ...
        (
            ...
            FieldSpec(
                "in_service",
                False,
                ("in_service", "estadoinstalacion", "estado", "outserv"),
                False,
            ),
        ),
    ),
    EntitySpec(
        ...
        (
            FieldSpec("id", True, ("id", "codigo", "code", "fid", "nis"), False),
            FieldSpec("name", False, ("name", "nombre", "nombredelcliente"), False),
            FieldSpec(
                "bus_id",
                True,
                (
            ...
            FieldSpec(
                "reactive_power_mvar",
                False,
                ("reactive_power_mvar", "q_mvar", "q", "kvar", "kvarh"),
                True,
            ),
            FieldSpec(
                "in_service",
                False,
                ("in_service", "estadoinstalacion", "estado", "estadodelsuminsitro"),
                False,
            ),
        ),
    ),
    EntitySpec(
        ...
        (
            ...
            FieldSpec("name", False, ("name", "nombre", "alimentador"), False),
            FieldSpec(
                "bus_id",
                True,
                ("bus_id", "nodo", "barra", "bus", "conexionn", "set", "sed"),
                False,
            ),
            FieldSpec(
                "nominal_voltage_kv",
            ...
            FieldSpec(
                "in_service",
                False,
                ("in_service", "estadoinstalacion", "estado"),
                False,
            ),
        ),
    ),
    EntitySpec(
        ...
        (
            FieldSpec(
                "id",
                True,
                ("id", "codigo", "fid", "codigodeequipo"),
                False,
            ),
            FieldSpec("name", False, ("name", "nombre", "codigodeequipo"), False),
            FieldSpec(
                "hv_bus",
                True,
                ("hv_bus", "nodo_at", "bus_hv", "alta", "sed"),
                False,
            ),
            FieldSpec(
                "lv_bus",
                True,
                ("lv_bus", "nodo_bt", "bus_lv", "baja", "sed"),
                False,
            ),
            FieldSpec(
                "hv_voltage_kv",
                ...
                (
                    ...
                    "tension_at",
                    "uhv",
                    "niveldetensionprimariakv",
                    "niveldetensionprimaria",
                ),
                True,
            ),
            FieldSpec(
                ...
                (
                    ...
                    "tension_bt",
                    "ulv",
                    "niveldetensionsecundariakv",
                    "niveldetensionsecundaria",
                ),
                True,
            ),
            FieldSpec(
                ...
                (
                    ...
                    "potencia",
                    "snom",
                    "potenciainstaladakva",
                    "capacidad",
                ),
                True,
            ),
            FieldSpec("type_id", False, ("type_id", "tipo", "modelo"), False),
        ),
    ),
    EntitySpec(
        "switches",
